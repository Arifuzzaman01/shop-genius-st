        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
              ...
              {/* Product Item 1 */}
              <div className="flex gap-4 p-3 border border-gray-100 rounded-lg group">
                <div className="relative w-16 h-16 bg-gray-100 rounded flex-shrink-0">
                  <Image src="/galaxyA17.avif" alt="product" fill className="object-cover rounded" />
                </div>
                <div className="flex-1">
                  <h4 className="text-sm font-semibold text-gray-800 line-clamp-1">MI powerbank 20000mah...</h4>
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-xs text-gray-400 line-through">৳1150</span>
                    <span className="text-sm font-bold text-green-600">৳1100</span>
                  </div>
                </div>
                <div className="flex items-center border border-gray-300 rounded-md h-8 self-center">
                  <button className="px-2 hover:bg-gray-100"><Minus size={14}/></button>
                  <span className="px-3 text-sm font-bold">3</span>
                  <button className="px-2 hover:bg-gray-100"><Plus size={14}/></button>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-3 border border-gray-100 rounded-lg group">
                <div className="relative w-16 h-16 bg-gray-100 rounded flex-shrink-0">
                  <Image src="/airbard.avif" alt="product" fill className="object-cover rounded" />
                </div>
                <div className="flex-1">
                  <h4 className="text-sm font-semibold text-gray-800 line-clamp-1">Samsung Galaxy A17 6GB...</h4>
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-xs text-gray-400 line-through">৳51990</span>
                    <span className="text-sm font-bold text-green-600">৳51000</span>
                  </div>
                </div>
                <div className="flex items-center border border-gray-300 rounded-md h-8 self-center">
                  <button className="px-2 hover:bg-gray-100"><Minus size={14}/></button>
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-gray-600">
                <span>Subtotal</span>
                <span className="font-bold text-gray-800">৳ 54300</span>
              </div>
              <div className="flex justify-between text-gray-600">
              ...
              <div className="border-t pt-3 flex justify-between items-center">
                ...
                <div className="text-right">
                    <span className="text-xl font-black text-green-700">৳ 54300</span>
                    <p className="text-[10px] text-gray-400 italic">VAT included, where applicable</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-3 cursor-pointer p-2 hover:bg-gray-50 rounded">
                  ...
                  />
                  <span className="text-sm font-bold text-gray-700 uppercase">CASH ON DELIVERY</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer p-2 hover:bg-gray-50 rounded">
                  <input
                    type="radio"
                  ...
                  />
                  <span className="text-sm font-bold text-gray-700 uppercase">PAYMENT METHOD</span>
                </label>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-3">
              <button className="w-full bg-[#00801a] text-white font-bold py-3.5 rounded hover:bg-green-700 uppercase transition-all tracking-wider">
                Confirm Order
              </button>
